import {
  ...
  const navigation = [
    ...
    { name: "Resources", href: "/resources", icon: Square2StackIcon },
    { name: "Buildings", href: "/buildings", icon: Square2StackIcon },
    { name: "Tecnologies", href: "/tecnologies", icon: Square2StackIcon },
    { name: "Defenses & Fleet", href: "/defenses", icon: Square2StackIcon },
    { name: "Merchant", href: "/merchant", icon: Square2StackIcon },
